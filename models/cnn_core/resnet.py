...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, in_chans=3,
        ...
        inplanes = int(channel_multiplier * inplanes)
        if deep_stem:
        ...
        channels = [int(channel_multiplier * i) for i in channels]
        ...
        self.num_features = int(512 * block.expansion * channel_multiplier)
...
@register_model
def resnet50_0375(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
    """
    model_args = dict(block=Bottleneck, layers=[3, 4, 6, 3], channel_multiplier=0.375, **kwargs)
    return _create_resnet('resnet50', pretrained, **model_args)


@register_model
def resnet50_050(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
    """
    model_args = dict(block=Bottleneck, layers=[3, 4, 6, 3], channel_multiplier=0.5, **kwargs)
    return _create_resnet('resnet50', pretrained, **model_args)


@register_model
def resnet50_0625(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
    """
    model_args = dict(block=Bottleneck, layers=[3, 4, 6, 3], channel_multiplier=0.625, **kwargs)
    return _create_resnet('resnet50', pretrained, **model_args)


@register_model
def resnet50_075(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
    """
    model_args = dict(block=Bottleneck, layers=[3, 4, 6, 3], channel_multiplier=0.75, **kwargs)
    return _create_resnet('resnet50', pretrained, **model_args)
